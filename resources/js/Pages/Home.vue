                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        >
                            ...
                            <div class="absolute inset-0 bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        </Link>
                    </div>
                    ...
                    >
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="w-6 transform transition-transform duration-300" 
                                :class="{ 'rotate-180': isMobileMenuOpen }">
                                <div class="w-full h-px bg-current transform transition-all duration-300" 
                                    :class="{ 'rotate-45 translate-y-px': isMobileMenuOpen }"></div>
                                <div class="w-full h-px bg-current mt-2 transform transition-all duration-300"
                                    :class="{ '-rotate-45 -translate-y-px': isMobileMenuOpen }"></div>
                            </div>
                        </div>
                    </button>
                ...
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="absolute inset-0 bg-gradient-to-r from-gray-100 to-gray-200 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section id="features" class="py-20 bg-white/50">
            <div class="container mx-auto px-6">
                <h2
                    ...
                    :class="{ 'translate-y-0 opacity-100': isFeaturesVisible, 'translate-y-4 opacity-0': !isFeaturesVisible }"
                >
...
<section id="pricing" class="py-20">
            <div class="container mx-auto px-6">
                <h2
                    class="text-3xl font-bold text-center mb-16 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent transform transition-all duration-700"
                    :class="{ 'translate-y-0 opacity-100': isPricingVisible, 'translate-y-4 opacity-0': !isPricingVisible }"
                >
                    Тарифные планы
                </h2>
                    ...
                    <template v-for="(plan, index) in pricingPlans" :key="index">
                        <div
                            ...
                            :class="[
                                ...
                                { 'translate-y-0 opacity-100': isPricingVisible, 'translate-y-4 opacity-0': !isPricingVisible }
                            ]"
                            :style="{ 'transition-delay': `${index * 150}ms` }"
                        >
                            <div v-if="plan.popular" class="absolute -top-4 left-1/2 transform -translate-x-1/2">
                                <span class="bg-gradient-to-r from-blue-600 to-violet-600 text-white text-sm font-semibold px-4 py-1 rounded-full">
                                    Популярный выбор
                                </span>
                            </div>
                            ...
                            >
                                ...
                                <div class="mb-6">
                                    <div class="flex items-baseline space-x-1">
                                        ...
                                        <span :class="plan.popular ? 'text-white/80' : 'text-gray-500'">/мес</span>
                                    </div>
                                </div>
                                <ul class="space-y-4 mb-8">
                                    <li v-for="feature in plan.features" :key="feature" class="flex items-center">
                                        <svg
                                            ...
                                            :class="plan.popular ? 'text-white' : 'text-green-500'"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                        ...
                                        <span :class="plan.popular ? 'text-white/90' : ''">{{ feature }}</span>
                                    </li>
                                </ul>
                                <button
                                    class="w-full relative overflow-hidden py-3 rounded-xl font-semibold transition-all duration-300 group"
                                    :class="plan.popular ? 'bg-white text-blue-600 hover:bg-white/90' : 'bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 text-white'"
                                >
                                    <span class="relative z-10">{{ plan.buttonText }}</span>
                                    <div 
                                        class="absolute inset-0 transform scale-x-0 transition-transform origin-left group-hover:scale-x-100"
                                        :class="plan.popular ? 'bg-white/90' : 'bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-600'"
                                    ></div>
                                </button>
                            </div>
                        </div>
        ...
        <section id="support" class="py-20 bg-white/50">
            <div class="container mx-auto px-6">
                <h2
                    class="text-3xl font-bold text-center mb-16 bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent transform transition-all duration-700"
                    :class="{ 'translate-y-0 opacity-100': isSupportVisible, 'translate-y-4 opacity-0': !isSupportVisible }"
                >
                    Поддержка 24/7
                </h2>
                ...
                <div class="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                    ...
                    <div 
                        ...
                        :class="{ 'translate-x-0 opacity-100': isSupportVisible, '-translate-x-4 opacity-0': !isSupportVisible }"
                    >
                        ...
                        <ul class="space-y-4">
                            <template v-for="(contact, index) in contacts" :key="index">
                                ...
                                >
                                    ...
                                    <div>
                                        <h4 class="font-semibold">{{ contact.title }}</h4>
                    ...
                    >
                        <form class="space-y-6" @submit.prevent="handleSubmit">
                            <div class="space-y-2">
                                <label class="block text-sm font-semibold">Ваше имя</label>
                                <div class="relative">
                                    <input
                                        v-model="form.name"
                                        type="text"
                                        ...
                                        :class="[
                                            ...
                                            { 'border-red-300 focus:border-red-500 focus:ring-red-200/50': formErrors.name }
                                        ]"
                                    />
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        :class="[
                                            'border-gray-200 focus:border-blue-500 focus:ring-blue-200/50',
                                            { 'border-red-300 focus:border-red-500 focus:ring-red-200/50': formErrors.email }
                                        ]"
                                    />
                                    <svg class="w-5 h-5 text-gray-400 absolute left-3 top-1/2 -translate-y-1/2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <div class="space-y-2">
                                <label class="block text-sm font-semibold">Сообщение</label>
                                <div class="relative">
                                    <textarea
                                        ...
                                        :class="[
                                            'border-gray-200 focus:border-blue-500 focus:ring-blue-200/50',
                                            { 'border-red-300 focus:border-red-500 focus:ring-red-200/50': formErrors.message }
                                        ]"
                                    ></textarea>
                                    <svg class="w-5 h-5 text-gray-400 absolute left-3 top-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <footer class="bg-gray-900 text-gray-400 py-12">
            <div class="container mx-auto px-6">
                <div class="grid md:grid-cols-4 gap-8">
                    <div class="space-y-6">
                        <div class="group flex items-center space-x-2 text-white">
                            <svg
                    ...
                    <template v-for="(column, index) in footerColumns" :key="index">
                        <div>
                            ...
                            <ul class="space-y-2 text-sm">
                                <li v-for="(link, linkIndex) in column.links" :key="linkIndex">
                                    ...
                                    >
                                        <span class="relative">
                                            {{ link.text }}
                                            <span class="absolute -bottom-px left-0 w-0 h-px bg-white transition-all group-hover:w-full"></span>
                                        </span>
                                        <svg 
                                            v-if="link.external"
