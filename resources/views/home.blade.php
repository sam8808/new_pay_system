...
@section('content')
    <div class="bg-gradient-to-r from-slate-950 to-gold-300">
        <header class="text-gray-700 body-font">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0"
                   href="{{route('home')}}">
                    <img class="w-48" src="{{asset('storage/img/main-logo.png')}}" alt="Logo">
                </a>
                <nav class="md:ml-auto text-white flex flex-wrap items-center text-base justify-center">
                    <a class="mr-5 hover:text-gray-900">{{__('Главная')}}</a>
                </nav>
                @auth('web')
                    <button
                        class="group relative inline-block overflow-hidden border border-black px-8 py-3 focus:outline-none focus:ring">
                        <span
                            class="absolute inset-y-0 left-0 w-[2px] bg-black transition-all group-hover:w-full group-active:bg-black"></span>
                        <span
                            class="relative text-sm font-medium text-black  transition-colors group-hover:text-gold-300">
                            {{__('В кабинет')}}
                        </span>
                    </button>
                @else
            ...
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div
                    ...
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-100">
                        {{__('Возможность осуществления финансовых операций для всех категорий клиентов')}}
                    </h1>
                    <p class="mb-8 text-gray-400 leading-relaxed">
                        {{__('Создайте свою уникальную финансовую историю с нашей платформой. У нас возможность осуществлять финансовые операции для всех категорий клиентов. Просто, удобно, без границ.')}}
                    </p>
                    <div class="flex justify-center">
                        <button
                            class="inline-flex text-white bg-indigo-500 border-0 py-3 px-12 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                            Button
                        </button>
                    </div>
                </div>
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img class="object-cover object-center rounded" alt="hero"
                         src="{{asset('storage/img/hero.png')}}">
                </div>
            </div>
        </section>
    </div>
    ...
    <section class="text-gray-700 body-font border-t border-gray-200">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                <h2 class="text-xs text-gray-200 tracking-widest font-medium title-font mb-1">ROOF PARTY POLAROID</h2>
        ...
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
            <div class="lg:w-1/4 mt-48 hidden lg:block">
                <div
                    ...
                    <p class="bg-gray-100 text-gray-900 h-12 text-center px-4 flex items-center justify-start">Feature
                        One</p>
                </div>
            </div>
    ...
    <a href="#"
       class="rounded-full w-12 h-12 bg-sky-600 fixed bottom-0 right-0 flex items-center justify-center -rotate-45 text-white mr-8 mb-8 shadow-xl"
       target="_blank">
